...
export default async function DashboardOverview() {
  ...
  // 2. Fetch Fixed Commitments & Calculate Monthly Total
  ...
  return (
    <div className={`space-y-8 ${poppins.className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Updated Total Income Card with Modal */}
        <Card className="shadow-sm border-none bg-[#1c1c1c] text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="shadow-sm border-gray-200">
          ...
          <CardContent>
            <SpendingBarChart needs={spentNeeds} wants={spentWants} savings={spentSavings} />
          </CardContent>
        </Card>
